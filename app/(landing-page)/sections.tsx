...
const items = [
  {
    ...
    image: "/images/twitter-profile.png",
  },
  {
    ...
    button: (
      <div className="text-sky-500 flex items-center  hover:cursor-pointer pt-6">
        Create and manage your unique decentralized identifier (TrustID) on the
        blockchain.
      </div>
    ),
  },
  {
    ...
    button: (
      <div className="text-sky-500 flex items-center  hover:cursor-pointer pt-6">
        Submit TrustID and get verified by trusted third parties.
      </div>
    ),
  },
  {
...
const Section = () => {
  return (
    <>
      ...
      <div
        className="grid xl:grid-cols-4 pb-32 md:grid-cols-2 md:row-span-1 gap-4 
    xl:gap-6 mt-8 px-8 md:px-16 xl:px-0 xl:w-3/4 2xl:w-[55%] mx-auto md:w-full"
      >
