...
const SocialMediaInputs: React.FC<SocialMediaInputsProps> = ({
  ...
  <>
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://x.com/abhishekrch"
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://www.instagram.com/abhishekrch"
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://www.youtube.com/user/abhishekrch"
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://www.linkedin.com/in/abhishekrch"
