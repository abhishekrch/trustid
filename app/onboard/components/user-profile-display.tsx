      ...
      <div className="flex flex-col items-center justify-center pt-4 mx-3">
        ...
        <div className="flex flex-col w-full ">
          <div className="flex flex-row items-center bg-gray-100 space-x-2 px-3 py-2 rounded-lg">
            ...
            <p className="text-sm">{formData.email || "proabhishekk@gmail.com"}</p>
          </div>
        ...
        <div className="inline-flex items-center justify-center w-full">
          ...
          <span className="absolute px-3 font-medium text-gray-900 -translate-x-1/2
           bg-white left-1/2 dark:text-white dark:bg-gray-900">
            Skills
          </span>
        </div>
