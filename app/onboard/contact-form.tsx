...
export default function CreateProfile() {
    ...
    const [formData, setFormData] = useState<FormValues>({
        ...
        info: "",
        imageUrl: "",
        skills: ["Blockchain", "DevOps", "Full Stack Dev"],
      });
      ...
      const handleChange = (name: string, value: any) => {
        ...
        if (name === "email" && value && !/.+@.+\..+/.test(value)) {
          ...
          ["x", "instagram", "youtube", "linkedin"].includes(name)
        ) {
      ...
      >
        <div>
          <div className="md:text-4xl text-xl font-medium w-3/3 pb-3">
            Creating a TrustID is a breeze with{" "}
            <span className="text-sky-500">TrustID</span>
          </div>
          <Toaster />
                ...
                <FormItem className="items-center justify-center w-full">
                  ...
                  <FormControl>
                    <textarea
                      ...
                      value={formData.info}
                      className="form-textarea border p-2 border-gray-300 
                      focus:outline-black rounded-md mt-1 block w-full"
                    />
                  </FormControl>
                </FormItem>
